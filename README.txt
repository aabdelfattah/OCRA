...
current set 3 saad is used

## Notes 

This implementation was a part of a graduate course project and actually it achieves very poor result, you can't rely on it for real OCR 
but it will be useful as a starting point to learn from and build on.
